...
<div id="map"></div>
	<div id="bbox">
	 ...
	 <div id="coordinates">
		...
		<@text name="eml.geospatialCoverages[0].description" value="${(eml.geospatialCoverages[0].description)!}" i18nkey="eml.geospatialCoverages.description" requiredField=true help="i18n" />
	<div class="buttons">
