...
public interface ResourceManager {
  ...
  /**
   * Returns the size of the generated PDF file.
   *
   * @param resource Resource
   *
   * @return size of PDF file
   */
  long getPdfSize(Resource resource);
  
  /**
   * Validate if the PDF existence for a specific resource in the data directory.
   *
   * @param shortName Resource shortname
   *
   * @return true if PDF File exists, and false otherwise.
   */
  boolean isPdfExisting(String shortName);
  ...
  boolean publish(Resource resource, int version, String nameCert, String lng, @Nullable BaseAction action) throws PublicationException;
