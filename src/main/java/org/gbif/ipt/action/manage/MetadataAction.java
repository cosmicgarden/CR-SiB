...
public class MetadataAction extends ManagerBaseAction {
  ...
  private String next = "additional";
  ...
  */
  ...
  private static final List<String> SECTIONS = Arrays
		    .asList("basic", "additional", "geocoverage", "taxcoverage", "tempcoverage", "methods", "collections", "project", "keywords", "parties");
  ...
  public void prepare() {
    ...
    //Athorities to show (CR-SiB)
    authorities = new LinkedHashMap<String, String>();
    authorities.put("", "Autoridades");
    authorities.putAll(cfg.loadAuthorities());
