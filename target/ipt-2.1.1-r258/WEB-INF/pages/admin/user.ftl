...
<p><@s.text name="admin.user.intro2"/></p>
	...
	<@input name="user.institution" />
	<@input name="user.identification" />
	<@select name="user.role" value=user.role javaGetter=false options={"Publisher":"user.roles.publisher", "Admin":"user.roles.admin"}/>
