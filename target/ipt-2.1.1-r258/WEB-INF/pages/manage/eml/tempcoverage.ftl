...
<script type="text/javascript">
	...
	$(document).ready(function() {	
		...
		<#if eml.temporalCoverages??>
			$( "#tempTypes-0").hide();
			$("label[for='tempTypes-0']").hide();
		</#if>
	...
	<div id="temporals">
		...
		<#list eml.temporalCoverages as temporalCoverage>
			<div id="temporal-${temporalCoverage_index}" class="tempo clearfix" >
				...
				-->
			<@select i18nkey="eml.temporalCoverages.type"  name="tempTypes-${temporalCoverage_index}" options=tempTypes value="DATE_RANGE" />
			<!-- Adding new subform -->
		...
		<#assign numt=eml.temporalCoverages?size>

		<#if numt==0>
		<div id="temporal-0" class="tempo clearfix" >
			<div>
				<@select i18nkey="eml.temporalCoverages.type"  name="tempTypes-0" options=tempTypes value="DATE_RANGE" />
			</div>
			<div id="date-0" class="typeForm" >
				<div class="halfcolumn">
					<@input date=true i18nkey="eml.temporalCoverages.startDate" name="eml.temporalCoverages[0].startDate" help="i18n" helpOptions={"YYYY-MM-DD":"YYYY-MM-DD",  "MM/DD/YYYY":"MM/DD/YYYY"}/>
				</div>
				<div class="halfcolumn">
					<@input date=true i18nkey="eml.temporalCoverages.endDate" name="eml.temporalCoverages[0].endDate" help="i18n" helpOptions={"YYYY-MM-DD":"YYYY-MM-DD",  "MM/DD/YYYY":"MM/DD/YYYY"}/>
				</div>
			</div>
		</div>
		</#if>
